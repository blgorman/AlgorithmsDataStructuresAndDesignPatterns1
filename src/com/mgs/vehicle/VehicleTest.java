...
public abstract class VehicleTest {
	...
	public abstract Vehicle getVehicle(String vin, String make, String model, int year, String color, double mileage);
	
	private Vehicle v;
	private Vehicle v2;
	//VIN
	protected static String VIN = "235423523asdfasda235235";
	//MAKE
	protected static String MAKE = "Ford";
	//MODEL
	...
	//Mileage
	protected static double MILEAGE = 25.0;
	protected static double DELTA = 0.00001;

	@Before
	public void setUp() throws Exception {
		v = getVehicle();
		v2 = getVehicle(VIN, MAKE, MODEL, YEAR, COLOR, MILEAGE);
	}
